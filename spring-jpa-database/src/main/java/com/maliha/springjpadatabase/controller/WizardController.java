...
public class WizardController {
    ...
    @DeleteMapping("/delete/wizard/{Wid}/house/{Hid}")
    public boolean deleteWizard(@PathVariable("Wid") Integer wizardId,@PathVariable("Hid") Integer HouseId) {
...
//        return true;
//    }
    @PutMapping("/update/wizard")
    public boolean updateWizard(@RequestBody Wizards wizard) throws NullPointerException{
